...
var (
	FailedToSetPageLoadTimeout  = errors.New("failed to set page load timeout")
	FailedToRetrievePage        = errors.New("failed to retrieve page")
	FailedToGetInnerHeight      = errors.New("failed to get inner height")
	FailedToScroll              = errors.New("failed to scroll")
